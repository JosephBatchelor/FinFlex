<?php
 ...
 if (isset($_SESSION['userId'])) {
    ...
    $sql4 = 'SELECT * FROM transactions WHERE Account_id = "'.$temp[$_COOKIE["test"]].'" AND DataToken = "'.$_SESSION['token'].'" ORDER BY DateOfTransaction ASC;';
        ...
        echo'
          ...
          while($row4 = mysqli_fetch_assoc($result4)){
            ...
            <script>
             ...
             myChart2.data.datasets[0].data['.$x.'] = '.(float)$row4['transaction_amount'].';
             myChart2.update();
            }
             update();
             </script>
